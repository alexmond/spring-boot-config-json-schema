...
class JsonSchemaBuilderTest {
	 ...
	 */
	@ParameterizedTest
	@CsvSource(value = { "java.util.Map<java.lang.String, java.lang.Integer>;java.lang.Integer",
			...
			"java.util.Map;java.util.Map", "InvalidTypeFormat;InvalidTypeFormat",
			"java.util.Map<java.lang.String, int[]>;int[]", ";" }, delimiter = ';')
	 ...
	 */
	@ParameterizedTest
	@CsvSource({ "camelCaseInput, camel-case-input", "word, word", "CamelCASEInput, camel-c-a-s-e-input", ",",
			"HelloWorld_specialTest, hello-world_special-test", "HTTPRequest, h-t-t-p-request",
	 ...
	 */
	@ParameterizedTest
	@CsvSource(value = { "java.util.List<java.lang.String>;java.lang.String",
			...
			"java.util.Set<java.lang.Double>;java.lang.Double", "SimpleString;object", ";" }, delimiter = ';')
