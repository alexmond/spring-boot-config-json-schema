...
class SanityJsonSchemaGeneratorTests {
	...
	void processEnumItem() {
		...
		assertTrue(values.containsAll(List.of("EN1", "en1", "EN2", "en2", "EN3", "en3")),
				"Values list should contain all enum values");
	...
	void generateSchema() throws Exception {
		...
		duplicates.entrySet()
			...
			.forEach(entry -> log.info("Duplicate count {},value: ===== {} ====== found in paths: {}",
