...
public class AsciiDoc {
	...
	public AsciiDoc(JsonSchemaProperties jsonSchemaProperties) {
		this.description = jsonSchemaProperties == null || jsonSchemaProperties.getDescription() == null ? ""
				: escapeForAsciiDoc(jsonSchemaProperties.getDescription());
		this.type = jsonSchemaProperties.getType().getValue();
		// this.pattern = jsonSchemaProperties.getHint() != null ?
		// jsonSchemaProperties.getHint().getPattern() : null;
		// this.example = jsonSchemaProperties.getHint() != null ?
		// jsonSchemaProperties.getHint().getExample() : null;
