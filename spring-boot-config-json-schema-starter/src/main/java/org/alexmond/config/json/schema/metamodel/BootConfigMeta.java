...
/**
 * Represents the metadata structure for Spring Boot configuration properties. This class
 * serves as a container for configuration metadata including groups, properties, hints,
