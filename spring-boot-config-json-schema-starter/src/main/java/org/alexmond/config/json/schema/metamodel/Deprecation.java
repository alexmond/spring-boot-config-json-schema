...
/**
 * Represents deprecation metadata for configuration properties. This class holds
 * information about deprecated configuration elements, including the reason for
 * deprecation, replacement options, severity level, and the version since when the
...
public class Deprecation {
	...
	/**
	 * Enumeration of possible deprecation severity levels. Both uppercase and lowercase
