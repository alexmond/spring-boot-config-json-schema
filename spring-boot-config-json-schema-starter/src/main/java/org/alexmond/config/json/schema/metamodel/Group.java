...
/**
 * Represents a configuration group that defines a specific set of related configuration
 * properties. This class is used in the JSON schema generation process to organize and
