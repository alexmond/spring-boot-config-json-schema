...
/**
 * Represents a hint value in the configuration metadata model. Hints provide additional
 * information about configuration properties, including possible values, descriptions,
...
public class HintValue {
	...
	/**
	 * Optional explanation for why this hint value is deprecated. Only relevant when
	 * deprecated is true.
	 */
