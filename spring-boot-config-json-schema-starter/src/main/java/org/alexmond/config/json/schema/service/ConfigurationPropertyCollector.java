...
public class ConfigurationPropertyCollector {
	...
	/**
	 * Collects all included property names from various sources. This includes properties
	 * from annotated beans, environment properties, and additional properties specified
	 ...
	 * Extracts the prefix from the annotation and adds it to the included properties
	 * list.
	...
	/**
	 * Collects all property keys from the environment. Adds non-null property keys to the
