...
import org.alexmond.config.json.schema.service.ConfigurationPropertyCollector;
...
import org.alexmond.config.json.schema.service.TypeMappingService;
...
/**
 * Configuration class that sets up the JSON Schema generation components for Spring Boot
 * configuration. This starter automatically configures all necessary beans for generating
 * JSON Schema representations of application configuration properties.
 */
@Configuration
public class ConfigSchemaStarter {
	...
	public ConfigurationPropertyCollector configurationPropertyCollector(ApplicationContext context,
			ConfigurableEnvironment env, JsonConfigSchemaConfig config, JsonSchemaBuilder schemaBuilder) {
	...
	/**
	 * Creates the main service for generating JSON Schema documents from configuration
	 * properties.
	 * @param config Configuration settings for JSON Schema generation
	...
	public JsonSchemaService jsonSchemaService(JsonConfigSchemaConfig config,
			ConfigurationPropertyCollector propertyCollector, JsonSchemaBuilder schemaBuilder,
