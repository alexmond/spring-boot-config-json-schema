:title: Spring Boot Config JSON Schema Generator
:description: Generate JSON Schema documentation from Spring Boot configuration properties
:keywords: spring-boot, json-schema, configuration, validation, documentation
...
A good article on this subject: xref:https://themightyprogrammer.dev/article/2ways-spring-configuration[Spring Boot Config Documentation, Two Ways With IntelliJ IDEA]
...
$schema: "https://www.alexmond.org/spring-boot-config-json-schema-starter/current/_attachments/boot-generic-config.json"
...
[source,yaml]
----
# yaml-language-server: $schema=https://www.alexmond.org/spring-boot-config-json-schema-starter/current/_attachments/boot-generic-config.yaml
