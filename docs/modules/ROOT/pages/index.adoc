...
:description: Auto-generate JSON Schema from your Spring Boot @ConfigurationProperties for IDE autocomplete and CI validation of application.yml and .properties.
...
- Full Spring Boot 4.x compatibility
