...
/**
 * Represents a deep level 2 configuration class that contains nested configuration
 * properties.
 * <p>
 * This class is used as part of the configuration hierarchy to hold collections of
 * {@link DeepLevel3} objects.
 * </p>
 */
@Data
@Schema(description = """
