...
1. Check the link:https://github.com/alexmond/spring-boot-config-json-schema/issues[Issues] tab for open tasks or create a new issue to propose your idea.
...
- Follow the existing code style. The build enforces spring-javaformat (Spring's Java format), Checkstyle, and PMD; run `mvn spring-javaformat:apply` to auto-format before committing.
...
Check link:https://github.com/alexmond/spring-boot-config-json-schema/issues[Issues] for tasks labeled
`good first issue`.

== Code of Conduct

We follow the link:https://www.contributor-covenant.org/version/2/0/code_of_conduct.html[Contributor Covenant Code of Conduct].
Please be respectful and inclusive in all interactions.

== Questions?

- Open an issue with the `question` label.
- Reach out via link:https://github.com/alexmond/spring-boot-config-json-schema/discussions[GitHub Discussions].
